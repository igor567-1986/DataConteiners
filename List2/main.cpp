...
void main()
{
	...
	List<std::string> s_list_1 = { "Хорошо", "живьет", "на", "свете", "Винни-Пух" };
...
{
	//Теперь любая переменная в классе может быть шаблонного типа,
	//а все методы автоматически становятся шаблонными.
};
/*
-----------------------------------------------------------------
Class - обычный класс.
Class<T> - шаблонный класс.
T - шаблонный, или конкретный тип данных.
-----------------------------------------------------------------
*/